...
const en = {
  ...
  "provider.apiKeyPlaceholderExisting": "Enter new key to update",
  "provider.modelsCount": "{{count}} models available",
  ...
  "conversation.loadMore": "Load more ({{count}} remaining)",
...
const zh: TranslationDictionary = {
  ...
  "conversation.loadMore": "加载更多（剩余 {{count}} 条）",
  "command.title": "命令面板",
