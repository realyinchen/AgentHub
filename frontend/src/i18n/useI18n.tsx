...
const en = {
  ...
  "model.defaultVLM": "Default VLM",
  "model.defaultEmbedding": "Default Embedding",
  ...
  "model.none": "None",
  "model.selectPlaceholder": "Select",
  "model.noModelsConfigured": "Configure models",
  ...
  "error.modelNameExists": "Model name already exists, please use another name",
  ...
  "error.deleteFailed": "Failed to delete model: {{details}}",
  ...
  "common.continueAdd": "Continue adding",
  "model.continueAdd": "Continue adding",
  "model.cancelAdd": "Cancel this model",
  ...
  "process.showSteps": "Show execution steps",
  "process.hideSteps": "Hide execution steps",
...
const zh: TranslationDictionary = {
  ...
  "model.defaultVLM": "默认VLM",
  "model.defaultEmbedding": "默认嵌入模型",
  "model.thinking": "思考",
  "model.type": "模型类型",
  "model.new": "新建模型",
  "model.active": "启用",
  "model.provider": "供应商",
  "model.none": "无",
  "model.selectPlaceholder": "选择",
  "model.noModelsConfigured": "配置模型",
  ...
  "provider.baseUrlPlaceholder": "http://localhost:11434/v1",
  "common.continueAdd": "继续添加",
  "model.continueAdd": "继续添加",
  "model.cancelAdd": "取消此模型",
  "model.title": "模型配置",
  "model.addModel": "添加模型",
  ...
  "process.content": "内容",
  "process.showSteps": "查看执行步骤",
  "process.hideSteps": "收起执行步骤",
  // Token stats
  "token.title": "Token 消耗",
  "token.input": "输入",
